...
The repository currently has no `LICENSE` file. Do not add a licensing claim to a new document until the owner provides the applicable terms. Keep internal ledgers and generated reports outside the repository.
...
- Do not publish internal metadata, validation ledgers, or process reports.
